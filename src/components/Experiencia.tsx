...
const JOBS = [
  { key: 'TOPLEVEL', resp: 3, current: true },
  { key: 'WEBSIFFY', resp: 2 },
...
function JobCard({
  ...
  const ref = useScrollReveal<HTMLDivElement>('fade-up', index * 80);
  ...
  return (
    <div ref={ref} className="relative pl-10 md:pl-14">
      ...
      <div className="group rounded-2xl border border-black/5 bg-white/90 p-5 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_14px_30px_rgba(0,0,0,0.15)] md:p-6">
        ...
        <ul className="mt-2 space-y-1.5">
          {Array.from({ length: respCount }).map((_, i) => (
            ...
            >
              <i className="fa-solid fa-angle-right mt-1 text-xs text-secondary" />
...
export default function Experiencia() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl rounded-3xl border border-white/20 bg-white/80 p-6 shadow-[0_8px_32px_rgba(0,0,0,0.25)] backdrop-blur-md md:p-10">
